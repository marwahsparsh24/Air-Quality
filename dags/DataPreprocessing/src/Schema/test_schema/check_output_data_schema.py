...
def get_schema():
    ...
    with open("data_schema_test.json", "w") as f:
        json.dump(schema, f)
    logger.info("Schema saved to 'data_schema_test.json'.")
    return schema
...
def main_test_schema():
    file_path = os.path.join(os.getcwd(), 'dags/DataPreprocessing/src/data_store_pkl_files/test_data/feature_eng_test_data.pkl')
