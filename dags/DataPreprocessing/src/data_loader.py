...
def stack_csvs_to_pickle():
    folder_path =os.path.join(os.getcwd(),"dags/DataPreprocessing/src/data_store_pkl_files/csv")
    output_pickle_file = os.path.join(os.getcwd(),"dags/DataPreprocessing/src/data_store_pkl_files/air_pollution.pkl")
