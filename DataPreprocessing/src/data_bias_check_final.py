...
main(
    '/Users/kuchibhotlaanirudharaghavasarma/Air-Quality/dags/DataPreprocessing/src/data_store_pkl_files/air_pollution.pkl', 
    sensitive_feature='month',
    threshold=0.2,
    save_path='/Users/kuchibhotlaanirudharaghavasarma/Air-Quality/resampled_data.pkl'
)
