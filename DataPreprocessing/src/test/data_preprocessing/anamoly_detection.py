...
def anamoly_detection_val():
    ...
    file_path = os.path.join(os.getcwd(), "DataPreprocessing/src/data_store_pkl_files/test_data/no_null_test_data.pkl")
    output_pickle_file = os.path.join(os.getcwd(), "DataPreprocessing/src/data_store_pkl_files/test_data/no_anamoly_test_data.pkl")
