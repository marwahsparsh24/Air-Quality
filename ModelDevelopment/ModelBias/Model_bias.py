...
print(curr_dir)
# Define paths
weights_dir = os.path.join(curr_dir, "weights")
feature_data_path = os.path.join(curr_dir, "DataPreprocessing/src/data_store_pkl_files/test_data/feature_eng_test_data.pkl")
